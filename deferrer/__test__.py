...
class Tests__sugarful:
    @staticmethod
    def test__should_raise__in_global_scope() -> None:
        with pytest.raises(RuntimeError):
            from ._samples import defer_in_global_scope__sugarful as _
...
class Tests__sugarless:
    @staticmethod
    def test__should_raise__in_global_scope() -> None:
        with pytest.raises(RuntimeError):
            from ._samples import defer_in_global_scope__sugarless as _
